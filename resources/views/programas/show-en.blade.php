                    ...
                    @if ($programa->inicio && $programa->fin)
                        ...
                        <div class="program-metrics-grid">
                            ...
                            <div class="metric-item">
                                ...
                                <div class="metric-content">
                                    <span class="metric-label">Passengers</span>
        ...
        <div class="floating-agents" id="floatingAgents">
            <div class="agents-floating-container">
                ...
                <div class="agents-title">
                    <i class="fa fa-headphones mr-1"></i> Your Travel Agents
                </div>
                @foreach ($programa->agentes as $agente)
            ...
            <ul class="nav nav-pills mb-0 program-tabs-nav" id="programTabs" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="overview-tab" data-toggle="tab" href="#overview" role="tab">
                        ...
                        <span class="d-none d-sm-inline">Program Overview</span>
                        <span class="d-inline d-sm-none">Overview</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="services-tab" data-toggle="tab" href="#services" role="tab">
                        <i class="fa fa-cutlery mr-2"></i>
                        <span class="d-none d-sm-inline">Services & Providers</span>
                        <span class="d-inline d-sm-none">Services</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="hotels-tab" data-toggle="tab" href="#hotels" role="tab">
                        ...
                        <span class="d-inline d-sm-none">Hotels</span>
                    </a>
                </li>
                <li class="nav-item">
                        ...
                        <div class="card-body p-4 p-md-5">
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted mb-0">Program overview will be available soon</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted mb-0">No service providers listed</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                                                                        ...
                                                                        @if ($fecha)
                                                                            <div class="gap-2 small">
                                                                                <div class="mr-3 mb-2">
                                                                                    ...
                                                                                    <span>Ingreso:</span>
                                                                                    <span>{{ \Carbon\Carbon::parse($fecha->fecha_ingreso)->format('d/m/Y') }}</span>
                                                                                </div>
                                                                                <div>
                                                                                    <i
                                                                                        class="fa fa-calendar-times-o text-dark"></i>
                                                                                    <span>Salida:</span>
                                                                                    <span>{{ \Carbon\Carbon::parse($fecha->fecha_salida)->format('d/m/Y') }}</span>
                                                                                </div>
                                                                            </div>
                                                                        @else
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted mb-0">No accommodation information</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="card-body p-4">
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted mb-0">No passenger data</p>
                                </div>
                            @endif
                        </div>
                    </div>
