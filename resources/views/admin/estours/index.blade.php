        ...
        <div class="row align-items-center ae-admin-page-header">
            <div class="col-lg-4 text-start mb-2 mb-lg-0">
                <h2 class="ae-admin-page-title">
                    <i class="fas fa-fw fa-map text-primary me-2"></i>
                    Tours en español
                </h2>
                <small class="ae-admin-page-desc">Listado y edición de tours ES</small>
            </div>
            <div class="col-lg-4 text-center mb-2 mb-lg-0">
                <span class="badge bg-success rounded-pill px-3 py-2">{{ $totalTours }} tours</span>
            </div>
            <div class="col-lg-4 text-lg-end">
                <a href="{{ route('estours.create') }}" class="btn btn-sm btn-primary">
                        ...
                        <tbody>
                            ...
                            @foreach ($tours as $tour)
                                <tr>
                                    ...
                                    <td>
                                        @if ($tour->tour)
                                            <span class="badge bg-success">{{ $tour->tour->nombre ?? 'Sin nombre' }}</span>
                                        @else
