...
<head>
    ...
    <meta name="twitter:description" content="The celebration for the day of Pachamama is an event that takes place in Cusco, it is a celebration.">
    <meta name="twitter:image" content="https://andeanexclusive.com/img/blog/pachamama-ceremony-andean-exclusive.jpg">
    <meta name="keywords" content="Pachamama, Cusco customs, travel to Peru, traditions, pachamama ceremony, ceremony for pacha mama, pacha mama exclusive tour" />
    <meta name="description" content="The celebration for the day of Pachamama is an event that takes place in Cusco, it is a celebration" />
                            ...
                            <nav class="main-nav">
                                <ul class="one-page-menu">
                                    ...
                                    <li id="display" class="menu-has-children">
                                        ...
                                        <ul>
                                            <li><a href="dia-de-la-pachamama">Español</a></li>
                                            <li><a>Ingles</a></li>
                                        </ul>
                                    </li>
                                    ...
                                    <li id="display2" class="menu-has-children">
                                        <a href="dia-de-la-pachamama">ES</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                        <a>EN</a>
                                    </li>
                                </ul>
                    ...
                    <div class="col-sm-12">
                        <article class="blog-item blog-single">
                            <div class="entry-excerpt">
                                <div data-vc-full-width="true" data-vc-full-width-init="false" data-onepage-title="Home" data-onepage-slug="home" class="vc_row wpb_row blog2 vc_row-has-fill  vc_row-o-content-middle vc_row-flex">
                                                    ...
                                                    <div class='swiper-container'>
                                                        <div class='swiper-wrapper'>
                                                            <div class='swiper-slide'>
                                                                <div class='cover-text ph5 text-light text-center pvnew pvb0'>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
