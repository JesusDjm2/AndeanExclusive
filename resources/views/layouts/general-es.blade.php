...
<body class="home page-template-default page page-id-44 wpb-js-composer js-comp-ver-5.4.5 vc_responsive">
    <a href="https://bit.ly/3kYXpXr" class="float" target="_blank" rel="nofollow noopener noreferrer">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="widget mb-0">
                            <p class="footer-copy">Copyright &copy; {{ date('Y') }} Andean Exclusive Tours | Todos los derechos reservados | Diseño:
